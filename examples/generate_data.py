...
# CLUSTER 0
cluster_0 = np.ones((3,2), dtype=np.int) * 0
cluster_0[0,1] = 3000
cluster_0[1,1] = 5000
cluster_0[2,1] = 7000
...
cluster_0_spike_scaling = np.array([0.88, 1.05, 0.9])
...
# CLUSTER 1
cluster_1 = np.ones((3,2), dtype=np.int) * 1
cluster_1[0,1] = 4000
cluster_1[1,1] = 6000
cluster_1[2,1] = 8000
...
cluster_1_spike_scaling = np.array([1.3, 0.73, 1.12])
...
# Insert 3 "spikes" for every cluster
for idx in range(3):
    # cluster 0
